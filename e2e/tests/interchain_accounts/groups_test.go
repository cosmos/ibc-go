...
const (
	...
	// DefaultVotingPeriod is the default voting period used for testing purposes
...
func (s *InterchainAccountsGroupsTestSuite) TestInterchainAccountsGroupsIntegration() {
	...
	t.Run("create group with new threshold decision policy", func(t *testing.T) {
		...
		decisionPolicy := grouptypes.NewThresholdDecisionPolicy(DefaultGroupThreshold, DefaultVotingPeriod, time.Duration(0))
