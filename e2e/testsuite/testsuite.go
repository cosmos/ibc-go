...
func (s *E2ETestSuite) CreateUserOnChainA(ctx context.Context, amount sdkmath.Int) ibc.Wallet {
...
func (s *E2ETestSuite) CreateUserOnChainB(ctx context.Context, amount sdkmath.Int) ibc.Wallet {
