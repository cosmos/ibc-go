...
require (
	...
	github.com/cosmos/ibc-go/modules/apps/callbacks v0.0.0-00010101000000-000000000000 // indirect
...
// we have to keep this replace statement until interchaintest updates to a later version of cosmos-sdk/x/upgrade
