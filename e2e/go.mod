...
require (
	...
	github.com/linxGnu/grocksdb v1.8.9 // indirect
...
replace github.com/strangelove-ventures/interchaintest/v8 => github.com/decentrio/interchaintest/v8 v8.0.1-0.20240118044258-5a92c8dbe711
