...
// source: sandbox/tokenfactory/tokenfactory.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "sandbox.tokenfactory.Params")
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "sandbox.tokenfactory.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("sandbox/tokenfactory/tokenfactory.proto", fileDescriptor_17f074b5b5a22274)
}
