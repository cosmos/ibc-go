...
type IBCApp struct {
	...
	OnAcknowledgementPacket func(ctx context.Context, sourceChannel string, destinationChannel string, payload channeltypesv2.Payload, acknowledgement []byte, relayer sdk.AccAddress) error
}
