...
<<<<<<< HEAD
		paramstypes.ModuleName, vestingtypes.ModuleName, ibcmock.ModuleName,
=======
		paramstypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, ibcmock.ModuleName,
>>>>>>> f7bb142 (build(deps): bump github.com/cosmos/cosmos-sdk from 0.44.5 to 0.45.0 (#769))
	)
...
<<<<<<< HEAD
		upgradetypes.ModuleName, vestingtypes.ModuleName, ibcmock.ModuleName,
=======
