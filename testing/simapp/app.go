...
func NewSimApp(
	...
	*/
	...
	genesisModuleOrder := []string{
		...
		icatypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, feegrant.ModuleName, paramstypes.ModuleName, upgradetypes.ModuleName, circuittypes.ModuleName,
