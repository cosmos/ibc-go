...
func NewSimApp(
	...
	scopedICAControllerKeeper := app.CapabilityKeeper.ScopeToModule(icatypes.ControllerModuleName)
	scopedICAHostKeeper := app.CapabilityKeeper.ScopeToModule(icatypes.HostModuleName)

	// NOTE: the IBC mock keeper and application module is used only for testing core IBC. Do
	// not replicate if you do not need to test core IBC or light clients.
	scopedIBCMockKeeper := app.CapabilityKeeper.ScopeToModule(ibcmock.ModuleName)
	scopedICAMockKeeper := app.CapabilityKeeper.ScopeToModule(ibcmock.ModuleName + icatypes.ControllerModuleName)
	...
	app.ICAHostKeeper = icahostkeeper.NewKeeper(
		appCodec, icatypes.HostModuleName, app.ICAKeeper,
		app.IBCKeeper.ChannelKeeper, &app.IBCKeeper.PortKeeper,
	...
	ibcRouter.AddRoute(icatypes.ControllerModuleName, icaControllerIBCModule).
		AddRoute(icatypes.HostModuleName, icaHostIBCModule).
		AddRoute(ibcmock.ModuleName+icatypes.ControllerModuleName, icaControllerIBCModule). // ica with mock auth module stack route to ica (top level of middleware stack)
