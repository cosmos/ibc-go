...
func NewTransferPath(chainA, chainB *ibctesting.TestChain) *ibctesting.Path {
	...
	path.EndpointA.ChannelConfig.Version = types.CurrentVersion
	path.EndpointB.ChannelConfig.Version = types.CurrentVersion
...
func (suite *TransferTestSuite) TestHandleMsgTransfer() {
	...
	msg := types.NewMsgTransfer(pathAtoB.EndpointA.ChannelConfig.PortID, pathAtoB.EndpointA.ChannelID, sdk.Coins{coinToSendToB}, suite.chainA.SenderAccount.GetAddress().String(), suite.chainB.SenderAccount.GetAddress().String(), timeoutHeight, 0, "")
	...
	msg = types.NewMsgTransfer(pathBtoC.EndpointA.ChannelConfig.PortID, pathBtoC.EndpointA.ChannelID, sdk.Coins{coinSentFromAToB}, suite.chainB.SenderAccount.GetAddress().String(), suite.chainC.SenderAccount.GetAddress().String(), timeoutHeight, 0, "")
	...
	msg = types.NewMsgTransfer(pathBtoC.EndpointB.ChannelConfig.PortID, pathBtoC.EndpointB.ChannelID, sdk.Coins{coinSentFromBToC}, suite.chainC.SenderAccount.GetAddress().String(), suite.chainB.SenderAccount.GetAddress().String(), timeoutHeight, 0, "")
