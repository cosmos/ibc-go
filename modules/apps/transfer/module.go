...
import (
	...
	"github.com/cosmos/ibc-go/v11/modules/apps/transfer/client/cli"
	"github.com/cosmos/ibc-go/v11/modules/apps/transfer/keeper"
	"github.com/cosmos/ibc-go/v11/modules/apps/transfer/simulation"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	if err := cfg.RegisterMigration(types.ModuleName, 6, m.MigrateChannelEscrow); err != nil {
		panic(fmt.Errorf("failed to migrate transfer app from version 6 to 7 (set per-channel escrow): %w", err))
	}
}
