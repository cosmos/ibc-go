...
type Allocation struct {
	...
	AllowedForwarding AllowedForwarding `protobuf:"bytes,6,opt,name=allowed_forwarding,json=allowedForwarding,proto3" json:"allowed_forwarding"`
}
...
type AllowedForwarding struct {
	...
	// destination
	AllowedHops []Hops `protobuf:"bytes,1,rep,name=allowed_hops,json=allowedHops,proto3" json:"allowed_hops"`
	// Whether to allow automatic unwinding of tokens to the original chain.
	AllowUnwind bool `protobuf:"varint,2,opt,name=allow_unwind,json=allowUnwind,proto3" json:"allow_unwind,omitempty"`
}
...
func (m *AllowedForwarding) GetAllowedHops() []Hops {
	if m != nil {
		return m.AllowedHops
	}
	return nil
}

func (m *AllowedForwarding) GetAllowUnwind() bool {
	if m != nil {
		return m.AllowUnwind
	}
	return false
}
...
func (*TransferAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1a28b55d17325aa, []int{3}
}
...
var fileDescriptor_b1a28b55d17325aa = []byte{
	...
	,
}
...
func (m *Allocation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.AllowedForwarding.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *AllowedForwarding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AllowedHops) > 0 {
		for iNdEx := len(m.AllowedHops) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AllowedHops[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Allocation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := m.AllowedForwarding.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AllowedForwarding) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedHops", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowedHops = append(m.AllowedHops, Hops{})
			if err := m.AllowedHops[len(m.AllowedHops)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowUnwind", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
