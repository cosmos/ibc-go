...
type MsgTransfer struct {
	...
	// boolean flag to indicate if the transfe message
	// is sent with the IBC v2 protocol.
	// This only needs to be set if the channel IDs
	// are V1 channel identifiers.
	IsV2 bool `protobuf:"varint,10,opt,name=is_v2,json=isV2,proto3" json:"is_v2,omitempty"`
}
...
var fileDescriptor_7401ed9bed2f8e09 = []byte{
	...
	,
}
...
func (m *MsgTransfer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsV2", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
