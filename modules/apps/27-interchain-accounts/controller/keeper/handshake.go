...
func (k Keeper) OnChanOpenInit(
	...
	if err := icatypes.ValidateMetadata(ctx, k.channelKeeper, connectionHops, metadata, true); err != nil {
		return "", err
	}
...
func (k Keeper) OnChanOpenAck(
	...
	if err := icatypes.ValidateMetadata(ctx, k.channelKeeper, channel.ConnectionHops, metadata, true); err != nil {
		return err
	}
