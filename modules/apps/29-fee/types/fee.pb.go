...
// PacketData defines the ICS29 packet data payload.
// Simple wrapper around single PacketFee for now.
type PacketData struct {
	PacketFee PacketFee `protobuf:"bytes,1,opt,name=packet_fee,json=packetFee,proto3" json:"packet_fee"`
}
...
func (m *PacketData) GetPacketFee() PacketFee {
	if m != nil {
		return m.PacketFee
	}
	return PacketFee{}
...
func init() {
	proto.RegisterType((*PacketData)(nil), "ibc.applications.fee.v1.PacketData")
...
var fileDescriptor_cb3319f1af2a53e5 = []byte{
	...
	,
}
