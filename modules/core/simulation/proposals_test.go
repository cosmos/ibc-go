...
func TestProposalMsgs(t *testing.T) {
	...
	msg, err := w0.MsgSimulatorFn()(ctx, r, accounts, nil) // TODO: codec
	...
	msg1, err := w1.MsgSimulatorFn()(ctx, r, accounts, nil) // TODO: codec
	require.NoError(t, err)
	...
	msg2, err := w2.MsgSimulatorFn()(ctx, r, accounts, nil) // TODO: codec
	require.NoError(t, err)
	...
	msg3, err := w3.MsgSimulatorFn()(ctx, r, accounts, nil) // TODO: codec
	require.NoError(t, err)
