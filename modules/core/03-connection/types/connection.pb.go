...
type Params struct {
	...
	MaxTimePerBlock uint64 `protobuf:"varint,1,opt,name=max_time_per_block,json=maxTimePerBlock,proto3" json:"max_time_per_block,omitempty" yaml:"max_time_per_block"`
}
...
func (m *Params) GetMaxTimePerBlock() uint64 {
	if m != nil {
...
var fileDescriptor_90572467c054e43a = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxTimePerBlock != 0 {
		i = encodeVarintConnection(dAtA, i, uint64(m.MaxTimePerBlock))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if m.MaxTimePerBlock != 0 {
		n += 1 + sovConnection(uint64(m.MaxTimePerBlock))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxTimePerBlock", wireType)
			}
			m.MaxTimePerBlock = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxTimePerBlock |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
