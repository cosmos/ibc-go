...
type ConnectionEnd struct {
	...
	// clients.
	DelayTimePeriod uint64 `protobuf:"varint,5,opt,name=delay_time_period,json=delayTimePeriod,proto3" json:"delay_time_period,omitempty" yaml:"delay_period"`
	// delay height period associated with this connection.
...
type IdentifiedConnection struct {
	...
	// delay time period associated with this connection.
	DelayTimePeriod uint64 `protobuf:"varint,6,opt,name=delay_time_period,json=delayTimePeriod,proto3" json:"delay_time_period,omitempty" yaml:"delay_time_period"`
	// delay height period associated with this connection.
	DelayHeightPeriod uint64 `protobuf:"varint,7,opt,name=delay_height_period,json=delayHeightPeriod,proto3" json:"delay_height_period,omitempty" yaml:"delay_height_period"`
}
...
var fileDescriptor_90572467c054e43a = []byte{
	...
	,
}
...
func (m *ConnectionEnd) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DelayHeightPeriod != 0 {
		i = encodeVarintConnection(dAtA, i, uint64(m.DelayHeightPeriod))
		i--
		dAtA[i] = 0x30
	}
	if m.DelayTimePeriod != 0 {
		i = encodeVarintConnection(dAtA, i, uint64(m.DelayTimePeriod))
		i--
		dAtA[i] = 0x28
	}
	{
...
func (m *ConnectionEnd) Size() (n int) {
	...
	n += 1 + l + sovConnection(uint64(l))
	if m.DelayTimePeriod != 0 {
		n += 1 + sovConnection(uint64(m.DelayTimePeriod))
	}
	if m.DelayHeightPeriod != 0 {
		n += 1 + sovConnection(uint64(m.DelayHeightPeriod))
	}
	return n
}
