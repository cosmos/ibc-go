...
type MsgConnectionOpenInit struct {
	...
	DelayTimePeriod   uint64       `protobuf:"varint,4,opt,name=delay_time_period,json=delayTimePeriod,proto3" json:"delay_time_period,omitempty" yaml:"delay_time_period"`
	DelayHeightPeriod uint64       `protobuf:"varint,5,opt,name=delay_height_period,json=delayHeightPeriod,proto3" json:"delay_height_period,omitempty" yaml:"delay_height_period"`
...
type MsgConnectionOpenTry struct {
	...
	DelayTimePeriod      uint64        `protobuf:"varint,5,opt,name=delay_time_period,json=delayTimePeriod,proto3" json:"delay_time_period,omitempty" yaml:"delay_time_period"`
	DelayHeightPeriod    uint64        `protobuf:"varint,6,opt,name=delay_height_period,json=delayHeightPeriod,proto3" json:"delay_height_period,omitempty" yaml:"delay_height_period"`
	CounterpartyVersions []*Version    `protobuf:"bytes,7,rep,name=counterparty_versions,json=counterpartyVersions,proto3" json:"counterparty_versions,omitempty" yaml:"counterparty_versions"`
	ProofHeight          types1.Height `protobuf:"bytes,8,opt,name=proof_height,json=proofHeight,proto3" json:"proof_height" yaml:"proof_height"`
	// proof of the initialization the connection on Chain A: `UNITIALIZED ->
	// INIT`
	ProofInit []byte `protobuf:"bytes,9,opt,name=proof_init,json=proofInit,proto3" json:"proof_init,omitempty" yaml:"proof_init"`
	// proof of client state included in message
	ProofClient []byte `protobuf:"bytes,10,opt,name=proof_client,json=proofClient,proto3" json:"proof_client,omitempty" yaml:"proof_client"`
	// proof of client consensus state
	ProofConsensus  []byte        `protobuf:"bytes,11,opt,name=proof_consensus,json=proofConsensus,proto3" json:"proof_consensus,omitempty" yaml:"proof_consensus"`
	ConsensusHeight types1.Height `protobuf:"bytes,12,opt,name=consensus_height,json=consensusHeight,proto3" json:"consensus_height" yaml:"consensus_height"`
...
var fileDescriptor_5d00fde5fc97399e = []byte{
	...
	,
}
...
func (m *MsgConnectionOpenInit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DelayHeightPeriod != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.DelayHeightPeriod))
		i--
		dAtA[i] = 0x28
	}
	if m.DelayTimePeriod != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.DelayTimePeriod))
		i--
		dAtA[i] = 0x20
	}
	if m.Version != nil {
...
func (m *MsgConnectionOpenInit) Size() (n int) {
	...
	if m.DelayTimePeriod != 0 {
		n += 1 + sovTx(uint64(m.DelayTimePeriod))
	}
	if m.DelayHeightPeriod != 0 {
		n += 1 + sovTx(uint64(m.DelayHeightPeriod))
	}
	l = len(m.Signer)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
...
func (m *MsgConnectionOpenInit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelayHeightPeriod", wireType)
			}
			m.DelayHeightPeriod = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DelayHeightPeriod |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
