...
type MsgProvideCounterparty struct {
	...
	PacketPath string `protobuf:"bytes,1,opt,name=packet_path,json=packetPath,proto3" json:"packet_path,omitempty"`
	// counterparty client
...
var fileDescriptor_3c556aec8b7966db = []byte{
	...
	,
}
...
func (m *MsgProvideCounterparty) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PacketPath) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.PacketPath)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *MsgProvideCounterparty) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.PacketPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
