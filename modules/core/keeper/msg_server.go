...
func (k Keeper) RecvPacket(goCtx context.Context, msg *channeltypes.MsgRecvPacket) (*channeltypes.MsgRecvPacketResponse, error) {
	...
	// Lookup module by channel capability
	// _, capability, err := k.ChannelKeeper.LookupModuleByChannel(ctx, msg.Packet.DestinationPort, msg.Packet.DestinationChannel)
	// if err != nil {
	...
	cacheCtx, writeFn = ctx.CacheContext()
	ack := k.PortKeeper.OnRecvPacket(cacheCtx, msg.Packet, relayer)
	...
	if ack != nil {
		if err := k.ChannelKeeper.WriteAcknowledgement(ctx, msg.Packet.DestinationPort, msg.Packet.DestinationChannel, msg.Packet.Sequence, ack); err != nil {
			return nil, err
		}
	}
...
func (k Keeper) Timeout(goCtx context.Context, msg *channeltypes.MsgTimeout) (*channeltypes.MsgTimeoutResponse, error) {
	...
	// Perform application logic callback
	err = k.PortKeeper.OnTimeoutPacket(ctx, msg.Packet, relayer)
	if err != nil {
...
func (k Keeper) Acknowledgement(goCtx context.Context, msg *channeltypes.MsgAcknowledgement) (*channeltypes.MsgAcknowledgementResponse, error) {
	...
	// }
	var ack types.RoutedPacketAcknowledgement
	err = k.cdc.UnmarshalJSON(msg.Acknowledgement, &ack)
	if err != nil {
		return nil, err
	}
	k.PortKeeper.OnAcknowledgementPacket(ctx, msg.Packet, ack, relayer)
