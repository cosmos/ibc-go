...
func (k *Keeper) emitChannelOpenInitEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
...
func (k *Keeper) emitChannelOpenTryEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelOpenAckEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelOpenConfirmEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelCloseInitEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelCloseConfirmEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitSendPacketEvent(ctx context.Context, packet types.Packet, channel types.Channel, timeoutHeight exported.Height) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitRecvPacketEvent(ctx context.Context, packet types.Packet, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitWriteAcknowledgementEvent(ctx context.Context, packet types.Packet, channel types.Channel, acknowledgement []byte) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitAcknowledgePacketEvent(ctx context.Context, packet types.Packet, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitTimeoutPacketEvent(ctx context.Context, packet types.Packet, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelClosedEvent(ctx context.Context, packet types.Packet, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeInitEvent(ctx context.Context, portID string, channelID string, channel types.Channel, upgrade types.Upgrade) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeTryEvent(ctx context.Context, portID string, channelID string, channel types.Channel, upgrade types.Upgrade) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeAckEvent(ctx context.Context, portID string, channelID string, channel types.Channel, upgrade types.Upgrade) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeConfirmEvent(ctx context.Context, portID, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeOpenEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeTimeoutEvent(ctx context.Context, portID string, channelID string, channel types.Channel, upgrade types.Upgrade) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitErrorReceiptEvent(ctx context.Context, portID string, channelID string, channel types.Channel, err error) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) EmitChannelUpgradeCancelEvent(ctx context.Context, portID string, channelID string, channel types.Channel, upgrade types.Upgrade) {
	k.EventService.EventManager(ctx).EmitKV(
...
func (k *Keeper) emitChannelFlushCompleteEvent(ctx context.Context, portID string, channelID string, channel types.Channel) {
	k.EventService.EventManager(ctx).EmitKV(
