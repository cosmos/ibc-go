...
func (suite *KeeperTestSuite) TestGetChannelVersion() {
	...
	version, found := suite.chainA.App.GetIBCKeeper().ChannelKeeper.GetChannelVersion(suite.chainA.GetContext(), path.EndpointA.ChannelConfig.PortID, path.EndpointA.ChannelID)
	...
	channelVersion, found := suite.chainA.App.GetIBCKeeper().ChannelKeeper.GetChannelVersion(suite.chainA.GetContext(), path.EndpointA.ChannelConfig.PortID, path.EndpointA.ChannelID)
