...
type MsgChannelUpgradeInit struct {
	...
	Timeout   Timeout       `protobuf:"bytes,4,opt,name=timeout,proto3" json:"timeout"`
	Signer    string        `protobuf:"bytes,5,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
type MsgChannelUpgradeTry struct {
	...
	UpgradeTimeout                Timeout      `protobuf:"bytes,4,opt,name=upgrade_timeout,json=upgradeTimeout,proto3" json:"upgrade_timeout"`
...
func (m *MsgChannelUpgradeTryResponse) GetResult() ResponseResultType {
	if m != nil {
		return m.Result
	}
	return UNSPECIFIED
...
type MsgChannelUpgradeAck struct {
	PortId                  string       `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
	ChannelId               string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	CounterpartyFlushStatus FlushStatus  `protobuf:"varint,3,opt,name=counterparty_flush_status,json=counterpartyFlushStatus,proto3,enum=ibc.core.channel.v1.FlushStatus" json:"counterparty_flush_status,omitempty"`
...
var fileDescriptor_bc4637e0ac3fc7b7 = []byte{
	...
	,
}
...
func (m *MsgChannelUpgradeAck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if m.CounterpartyFlushStatus != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.CounterpartyFlushStatus))
		i--
		dAtA[i] = 0x18
	}
	if len(m.ChannelId) > 0 {
...
func (m *MsgChannelUpgradeAck) Size() (n int) {
	...
	if m.CounterpartyFlushStatus != 0 {
		n += 1 + sovTx(uint64(m.CounterpartyFlushStatus))
	}
...
func (m *MsgChannelUpgradeAck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CounterpartyFlushStatus", wireType)
			}
			m.CounterpartyFlushStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CounterpartyFlushStatus |= FlushStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
