...
// MsgPruneStalePacketState defines the request type for the PruneStalePacketState rpc.
type MsgPruneStalePacketState struct {
	PortId    string `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
	ChannelId string `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
...
func (m *MsgPruneStalePacketState) Reset()         { *m = MsgPruneStalePacketState{} }
func (m *MsgPruneStalePacketState) String() string { return proto.CompactTextString(m) }
func (*MsgPruneStalePacketState) ProtoMessage()    {}
func (*MsgPruneStalePacketState) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc4637e0ac3fc7b7, []int{36}
}
func (m *MsgPruneStalePacketState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgPruneStalePacketState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgPruneStalePacketState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgPruneStalePacketState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgPruneStalePacketState.Merge(m, src)
}
func (m *MsgPruneStalePacketState) XXX_Size() int {
	return m.Size()
}
func (m *MsgPruneStalePacketState) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgPruneStalePacketState.DiscardUnknown(m)
}

var xxx_messageInfo_MsgPruneStalePacketState proto.InternalMessageInfo

// MsgPruneStalePacketStateResponse defines the response type for the PruneStalePacketState rpc.
type MsgPruneStalePacketStateResponse struct {
	// Number of sequences pruned (might include both packet acknowledgements and packet receipts).
	PrunedSequences uint64 `protobuf:"varint,1,opt,name=pruned_sequences,json=prunedSequences,proto3" json:"pruned_sequences,omitempty"`
	// Number of sequences left after pruning.
	RemainingSequences uint64 `protobuf:"varint,2,opt,name=remaining_sequences,json=remainingSequences,proto3" json:"remaining_sequences,omitempty"`
}

func (m *MsgPruneStalePacketStateResponse) Reset()         { *m = MsgPruneStalePacketStateResponse{} }
func (m *MsgPruneStalePacketStateResponse) String() string { return proto.CompactTextString(m) }
func (*MsgPruneStalePacketStateResponse) ProtoMessage()    {}
func (*MsgPruneStalePacketStateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc4637e0ac3fc7b7, []int{37}
}
func (m *MsgPruneStalePacketStateResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgPruneStalePacketStateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgPruneStalePacketStateResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgPruneStalePacketStateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgPruneStalePacketStateResponse.Merge(m, src)
}
func (m *MsgPruneStalePacketStateResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgPruneStalePacketStateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgPruneStalePacketStateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgPruneStalePacketStateResponse proto.InternalMessageInfo

func (m *MsgPruneStalePacketStateResponse) GetPrunedSequences() uint64 {
	if m != nil {
		return m.PrunedSequences
	}
	return 0
}

func (m *MsgPruneStalePacketStateResponse) GetRemainingSequences() uint64 {
	if m != nil {
		return m.RemainingSequences
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*MsgPruneStalePacketState)(nil), "ibc.core.channel.v1.MsgPruneStalePacketState")
	proto.RegisterType((*MsgPruneStalePacketStateResponse)(nil), "ibc.core.channel.v1.MsgPruneStalePacketStateResponse")
}
...
var fileDescriptor_bc4637e0ac3fc7b7 = []byte{
	...
	,
	...
	0x74, 0x14, 0x23, 0xe3, 0xa2, 0xd7, 0xf6, 0x4f, 0x38, 0xef, 0x06, 0xc6, 0x13, 0xbc, 0xcb, 0xd2,
	0x3b, 0x90, 0xa6, 0xa9, 0x4f, 0x13, 0x67, 0x7d, 0x52, 0x34, 0xce, 0xc9, 0x83, 0x0e, 0xb1, 0x8b,
	...
	,
}
...
type MsgClient interface {
	...
	PruneStalePacketState(ctx context.Context, in *MsgPruneStalePacketState, opts ...grpc.CallOption) (*MsgPruneStalePacketStateResponse, error)
}
...
func (c *msgClient) PruneStalePacketState(ctx context.Context, in *MsgPruneStalePacketState, opts ...grpc.CallOption) (*MsgPruneStalePacketStateResponse, error) {
	out := new(MsgPruneStalePacketStateResponse)
	err := c.cc.Invoke(ctx, "/ibc.core.channel.v1.Msg/PruneStalePacketState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// PruneStalePacketState defines a rpc handler method for MsgPruneStalePacketState.
	PruneStalePacketState(context.Context, *MsgPruneStalePacketState) (*MsgPruneStalePacketStateResponse, error)
}
...
func (*UnimplementedMsgServer) PruneStalePacketState(ctx context.Context, req *MsgPruneStalePacketState) (*MsgPruneStalePacketStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PruneStalePacketState not implemented")
}
...
func _Msg_PruneStalePacketState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgPruneStalePacketState)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).PruneStalePacketState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ibc.core.channel.v1.Msg/PruneStalePacketState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).PruneStalePacketState(ctx, req.(*MsgPruneStalePacketState))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PruneStalePacketState",
			Handler:    _Msg_PruneStalePacketState_Handler,
		},
	},
...
func (m *MsgPruneStalePacketState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgPruneStalePacketState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgPruneStalePacketState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgPruneStalePacketStateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgPruneStalePacketStateResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgPruneStalePacketStateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.RemainingSequences != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.RemainingSequences))
		i--
		dAtA[i] = 0x10
	}
	if m.PrunedSequences != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.PrunedSequences))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MsgPruneStalePacketState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgPruneStalePacketStateResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.PrunedSequences != 0 {
		n += 1 + sovTx(uint64(m.PrunedSequences))
	}
	if m.RemainingSequences != 0 {
		n += 1 + sovTx(uint64(m.RemainingSequences))
	}
	return n
}
...
func (m *MsgPruneStalePacketState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgPruneStalePacketState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgPruneStalePacketState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgPruneStalePacketStateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgPruneStalePacketStateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgPruneStalePacketStateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrunedSequences", wireType)
			}
			m.PrunedSequences = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrunedSequences |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemainingSequences", wireType)
			}
			m.RemainingSequences = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RemainingSequences |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
