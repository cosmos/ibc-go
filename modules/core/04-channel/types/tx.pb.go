...
type MsgPruneAcknowledgements struct {
	PortId     string `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
	ChannelId  string `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	NumToPrune uint64 `protobuf:"varint,3,opt,name=num_to_prune,json=numToPrune,proto3" json:"num_to_prune,omitempty"`
	Signer     string `protobuf:"bytes,4,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
var fileDescriptor_bc4637e0ac3fc7b7 = []byte{
	...
	,
}
...
func (m *MsgPruneAcknowledgements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NumToPrune != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.NumToPrune))
		i--
		dAtA[i] = 0x18
	}
	if len(m.ChannelId) > 0 {
...
func (m *MsgPruneAcknowledgements) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumToPrune", wireType)
			}
			m.NumToPrune = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumToPrune |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
