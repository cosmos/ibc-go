...
type MsgChannelUpgradeTry struct {
	...
	CounterpartyProposedUpgrade Upgrade      `protobuf:"bytes,4,opt,name=counterparty_proposed_upgrade,json=counterpartyProposedUpgrade,proto3" json:"counterparty_proposed_upgrade"`
