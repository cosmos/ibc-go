...
type MsgChannelUpgradeInit struct {
	PortId                 string       `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty" yaml:"port_id"`
	ChannelId              string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty" yaml:"channel_id"`
	ProposedUpgradeChannel Channel      `protobuf:"bytes,3,opt,name=proposed_upgrade_channel,json=proposedUpgradeChannel,proto3" json:"proposed_upgrade_channel" yaml:"proposed_upgrade_channel"`
...
func (m *MsgChannelUpgradeInitResponse) GetChannelId() string {
	if m != nil {
		return m.ChannelId
	}
	return ""
...
func (m *MsgChannelUpgradeInitResponse) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
type MsgChannelUpgradeTry struct {
	PortId                 string       `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty" yaml:"port_id"`
	ChannelId              string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty" yaml:"channel_id"`
	CounterpartyChannel    Channel      `protobuf:"bytes,3,opt,name=counterparty_channel,json=counterpartyChannel,proto3" json:"counterparty_channel" yaml:"counterparty_channel"`
	CounterpartySequence   uint64       `protobuf:"varint,4,opt,name=counterparty_sequence,json=counterpartySequence,proto3" json:"counterparty_sequence,omitempty" yaml:"counterparty_sequence"`
	ProposedUpgradeChannel Channel      `protobuf:"bytes,5,opt,name=proposed_upgrade_channel,json=proposedUpgradeChannel,proto3" json:"proposed_upgrade_channel" yaml:"proposed_upgrade_channel"`
	...
	ProofChannel           []byte       `protobuf:"bytes,8,opt,name=proof_channel,json=proofChannel,proto3" json:"proof_channel,omitempty" yaml:"proof_channel"`
	ProofUpgradeTimeout    []byte       `protobuf:"bytes,9,opt,name=proof_upgrade_timeout,json=proofUpgradeTimeout,proto3" json:"proof_upgrade_timeout,omitempty" yaml:"proof_upgrade_timeout"`
	ProofUpgradeSequence   []byte       `protobuf:"bytes,10,opt,name=proof_upgrade_sequence,json=proofUpgradeSequence,proto3" json:"proof_upgrade_sequence,omitempty" yaml:"proof_upgrade_sequence"`
	ProofHeight            types.Height `protobuf:"bytes,11,opt,name=proof_height,json=proofHeight,proto3" json:"proof_height" yaml:"proof_height"`
...
type MsgChannelUpgradeAck struct {
	...
	ChannelId            string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty" yaml:"channel_id"`
	CounterpartyChannel  Channel      `protobuf:"bytes,3,opt,name=counterparty_channel,json=counterpartyChannel,proto3" json:"counterparty_channel" yaml:"counterparty_channel"`
	ProofChannel         []byte       `protobuf:"bytes,4,opt,name=proof_channel,json=proofChannel,proto3" json:"proof_channel,omitempty" yaml:"proof_channel"`
	ProofUpgradeSequence []byte       `protobuf:"bytes,5,opt,name=proof_upgrade_sequence,json=proofUpgradeSequence,proto3" json:"proof_upgrade_sequence,omitempty" yaml:"proof_upgrade_sequence"`
	ProofHeight          types.Height `protobuf:"bytes,6,opt,name=proof_height,json=proofHeight,proto3" json:"proof_height" yaml:"proof_height"`
	Signer               string       `protobuf:"bytes,7,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
type MsgChannelUpgradeConfirm struct {
	...
	CounterpartyChannel  Channel      `protobuf:"bytes,3,opt,name=counterparty_channel,json=counterpartyChannel,proto3" json:"counterparty_channel" yaml:"counterparty_channel"`
	ProofChannel         []byte       `protobuf:"bytes,4,opt,name=proof_channel,json=proofChannel,proto3" json:"proof_channel,omitempty" yaml:"proof_channel"`
	ProofUpgradeError    []byte       `protobuf:"bytes,5,opt,name=proof_upgrade_error,json=proofUpgradeError,proto3" json:"proof_upgrade_error,omitempty" yaml:"proof_upgrade_error"`
	ProofUpgradeSequence []byte       `protobuf:"bytes,6,opt,name=proof_upgrade_sequence,json=proofUpgradeSequence,proto3" json:"proof_upgrade_sequence,omitempty" yaml:"proof_upgrade_sequence"`
...
type MsgChannelUpgradeTimeout struct {
	...
	ChannelId            string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty" yaml:"channel_id"`
	CounterpartyChannel  Channel      `protobuf:"bytes,3,opt,name=counterparty_channel,json=counterpartyChannel,proto3" json:"counterparty_channel" yaml:"counterparty_channel"`
	PreviousErrorReceipt ErrorReceipt `protobuf:"bytes,4,opt,name=previous_error_receipt,json=previousErrorReceipt,proto3" json:"previous_error_receipt" yaml:"previous_error_receipt"`
	ProofChannel         []byte       `protobuf:"bytes,5,opt,name=proof_channel,json=proofChannel,proto3" json:"proof_channel,omitempty" yaml:"proof_channel"`
	ProofErrorReceipt    []byte       `protobuf:"bytes,6,opt,name=proof_error_receipt,json=proofErrorReceipt,proto3" json:"proof_error_receipt,omitempty" yaml:"proof_error_receipt"`
	ProofHeight          types.Height `protobuf:"bytes,7,opt,name=proof_height,json=proofHeight,proto3" json:"proof_height" yaml:"proof_height"`
	Signer               string       `protobuf:"bytes,8,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
type MsgChannelUpgradeCancel struct {
	PortId            string       `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty" yaml:"port_id"`
	ChannelId         string       `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty" yaml:"channel_id"`
	ErrorReceipt      ErrorReceipt `protobuf:"bytes,3,opt,name=error_receipt,json=errorReceipt,proto3" json:"error_receipt" yaml:"error_receipt"`
	ProofErrorReceipt []byte       `protobuf:"bytes,4,opt,name=proof_error_receipt,json=proofErrorReceipt,proto3" json:"proof_error_receipt,omitempty" yaml:"proof_error_receipt"`
...
var fileDescriptor_bc4637e0ac3fc7b7 = []byte{
	...
	,
}
...
func (m *MsgChannelUpgradeInit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	{
		size, err := m.ProposedUpgradeChannel.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgChannelUpgradeTry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x5a
	if len(m.ProofUpgradeSequence) > 0 {
		i -= len(m.ProofUpgradeSequence)
		copy(dAtA[i:], m.ProofUpgradeSequence)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ProofUpgradeSequence)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.ProofUpgradeTimeout) > 0 {
		i -= len(m.ProofUpgradeTimeout)
		copy(dAtA[i:], m.ProofUpgradeTimeout)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ProofUpgradeTimeout)))
		i--
		dAtA[i] = 0x4a
	}
	...
	i--
	dAtA[i] = 0x2a
	if m.CounterpartySequence != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.CounterpartySequence))
		i--
		dAtA[i] = 0x20
	}
	{
...
func (m *MsgChannelUpgradeConfirm) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProofUpgradeError) > 0 {
		i -= len(m.ProofUpgradeError)
		copy(dAtA[i:], m.ProofUpgradeError)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ProofUpgradeError)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ProofChannel) > 0 {
...
func (m *MsgChannelUpgradeInit) Size() (n int) {
	...
	l = m.ProposedUpgradeChannel.Size()
	n += 1 + l + sovTx(uint64(l))
...
func (m *MsgChannelUpgradeTry) Size() (n int) {
	...
	n += 1 + l + sovTx(uint64(l))
	if m.CounterpartySequence != 0 {
		n += 1 + sovTx(uint64(m.CounterpartySequence))
	}
	l = m.ProposedUpgradeChannel.Size()
	n += 1 + l + sovTx(uint64(l))
	l = m.TimeoutHeight.Size()
	...
	l = len(m.ProofUpgradeTimeout)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	l = len(m.ProofUpgradeSequence)
	if l > 0 {
		n += 1 + l + sovTx(uint64(l))
	}
	l = m.ProofHeight.Size()
...
func (m *MsgChannelUpgradeInit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposedUpgradeChannel", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ProposedUpgradeChannel.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *MsgChannelUpgradeTry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CounterpartySequence", wireType)
			}
			m.CounterpartySequence = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CounterpartySequence |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProofUpgradeTimeout", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProofUpgradeTimeout = append(m.ProofUpgradeTimeout[:0], dAtA[iNdEx:postIndex]...)
			if m.ProofUpgradeTimeout == nil {
				m.ProofUpgradeTimeout = []byte{}
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProofUpgradeSequence", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProofUpgradeSequence = append(m.ProofUpgradeSequence[:0], dAtA[iNdEx:postIndex]...)
			if m.ProofUpgradeSequence == nil {
				m.ProofUpgradeSequence = []byte{}
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
...
func (m *MsgChannelUpgradeConfirm) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProofUpgradeError", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProofUpgradeError = append(m.ProofUpgradeError[:0], dAtA[iNdEx:postIndex]...)
			if m.ProofUpgradeError == nil {
				m.ProofUpgradeError = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
