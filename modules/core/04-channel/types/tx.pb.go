...
type MsgChannelUpgradeInit struct {
	PortId          string  `protobuf:"bytes,1,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
	ChannelId       string  `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	ProposedUpgrade Upgrade `protobuf:"bytes,3,opt,name=proposed_upgrade,json=proposedUpgrade,proto3" json:"proposed_upgrade"`
	Signer          string  `protobuf:"bytes,4,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
func (m *MsgChannelUpgradeTryResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
var fileDescriptor_bc4637e0ac3fc7b7 = []byte{
	...
	,
}
