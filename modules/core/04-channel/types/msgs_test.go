...
func (suite *TypesTestSuite) TestMsgChannelOpenInitValidateBasic() {
	...
	testCases := []struct {
		...
		{"invalid channel order", types.NewMsgChannelOpenInit(portid, version, types.NONE, connHops, cpportid, addr), false},
...
func (suite *TypesTestSuite) TestMsgChannelOpenTryValidateBasic() {
	...
	testCases := []struct {
		...
		{"invalid channel order", types.NewMsgChannelOpenTry(portid, chanid, version, types.NONE, connHops, cpportid, cpchanid, version, suite.proof, height, addr), false},
