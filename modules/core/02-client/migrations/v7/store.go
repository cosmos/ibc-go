...
func handleTendermintMigration(ctx sdk.Context, store sdk.KVStore, clientKeeper ClientKeeper) error {
...
func handleLocalhostMigration(ctx sdk.Context, store sdk.KVStore, clientKeeper ClientKeeper) error {
