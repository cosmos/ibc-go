...
func (m *QueryClientStateRequest) GetHeight() *Height {
	if m != nil {
		return m.Height
	}
	return nil
...
func (m *QueryClientStateRequest) GetLatestHeight() bool {
	if m != nil {
...
type QueryUpgradedClientStateRequest struct {
	...
	// latest_height overrides the height field and queries the latest stored
	// UpgradedClientState
	LatestHeight bool `protobuf:"varint,2,opt,name=latest_height,json=latestHeight,proto3" json:"latest_height,omitempty"`
}
...
func (m *QueryUpgradedClientStateRequest) GetHeight() *Height {
	if m != nil {
		return m.Height
	}
	return nil
...
func (m *QueryUpgradedClientStateRequest) GetLatestHeight() bool {
	if m != nil {
		return m.LatestHeight
	}
	return false
...
func (m *QueryUpgradedConsensusStateRequest) GetHeight() *Height {
	if m != nil {
		return m.Height
	}
	return nil
...
func (m *QueryUpgradedConsensusStateRequest) GetLatestHeight() bool {
	if m != nil {
		return m.LatestHeight
	}
	return false
...
var fileDescriptor_dc42cdfd1d52d76e = []byte{
	...
	,
}
