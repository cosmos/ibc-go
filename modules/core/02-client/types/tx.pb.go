...
type MsgCreateClient struct {
	...
	// Types that are valid to be assigned to XCounterpartyId:
	//	*MsgCreateClient_CounterpartyId
	XCounterpartyId isMsgCreateClient_XCounterpartyId `protobuf_oneof:"_counterparty_id"`
}
...
type isMsgCreateClient_XCounterpartyId interface {
	isMsgCreateClient_XCounterpartyId()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MsgCreateClient_CounterpartyId struct {
	CounterpartyId string `protobuf:"bytes,4,opt,name=counterparty_id,json=counterpartyId,proto3,oneof" json:"counterparty_id,omitempty"`
}

func (*MsgCreateClient_CounterpartyId) isMsgCreateClient_XCounterpartyId() {}

func (m *MsgCreateClient) GetXCounterpartyId() isMsgCreateClient_XCounterpartyId {
	if m != nil {
		return m.XCounterpartyId
	}
	return nil
}

func (m *MsgCreateClient) GetCounterpartyId() string {
	if x, ok := m.GetXCounterpartyId().(*MsgCreateClient_CounterpartyId); ok {
...
func (*MsgCreateClient) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MsgCreateClient_CounterpartyId)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*MsgProvideCounterparty)(nil), "ibc.core.client.v1.MsgProvideCounterparty")
	proto.RegisterType((*MsgProvideCounterpartyResponse)(nil), "ibc.core.client.v1.MsgProvideCounterpartyResponse")
...
var fileDescriptor_cb5dc4651eb49a04 = []byte{
	...
	,
}
...
func (c *msgClient) ProvideCounterparty(ctx context.Context, in *MsgProvideCounterparty, opts ...grpc.CallOption) (*MsgProvideCounterpartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ibc.core.client.v1.Msg/ProvideCounterparty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ProvideCounterparty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ibc.core.client.v1.Msg/ProvideCounterparty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgCreateClient) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.XCounterpartyId != nil {
		{
			size := m.XCounterpartyId.Size()
			i -= size
			if _, err := m.XCounterpartyId.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *MsgCreateClient_CounterpartyId) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgCreateClient_CounterpartyId) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.CounterpartyId)
	copy(dAtA[i:], m.CounterpartyId)
	i = encodeVarintTx(dAtA, i, uint64(len(m.CounterpartyId)))
	i--
	dAtA[i] = 0x22
	return len(dAtA) - i, nil
}
...
func (m *MsgCreateClient) Size() (n int) {
	...
	if m.XCounterpartyId != nil {
		n += m.XCounterpartyId.Size()
	}
	return n
}

func (m *MsgCreateClient_CounterpartyId) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgCreateClient) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.XCounterpartyId = &MsgCreateClient_CounterpartyId{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
