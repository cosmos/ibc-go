...
import (
	context "context"
	types2 "cosmossdk.io/x/upgrade/types"
	fmt "fmt"
...
type MsgCreateClient struct {
	...
	// merklePath prefix is the prefix added to the ICS24 path before it is ready to be proven
	MerklePathPrefix *types1.MerklePath `protobuf:"bytes,5,opt,name=merkle_path_prefix,json=merklePathPrefix,proto3" json:"merkle_path_prefix,omitempty"`
}
...
type MsgProvideCounterparty struct {
	...
	// merklePath prefix is the prefix added to the ICS24 path before it is ready to be proven
	// the ICS24 path will be appended to the last element, then the total merkle path will be passed
	// directly to the client for verification
	MerklePathPrefix *types1.MerklePrefix `protobuf:"bytes,3,opt,name=merkle_path_prefix,json=merklePathPrefix,proto3" json:"merkle_path_prefix,omitempty"`
	// signer address
...
type MsgIBCSoftwareUpgrade struct {
	Plan types2.Plan `protobuf:"bytes,1,opt,name=plan,proto3" json:"plan"`
...
func (m *MsgIBCSoftwareUpgrade) GetPlan() types2.Plan {
	if m != nil {
		return m.Plan
	}
	return types2.Plan{}
...
var fileDescriptor_cb5dc4651eb49a04 = []byte{
	...
	,
}
...
func (m *MsgCreateClient) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.MerklePathPrefix == nil {
				m.MerklePathPrefix = &types1.MerklePath{}
			}
...
func (m *MsgProvideCounterparty) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.MerklePathPrefix == nil {
				m.MerklePathPrefix = &types1.MerklePrefix{}
			}
			if err := m.MerklePathPrefix.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
