...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.header = chainATendermint.CreateTMClientHeader(testChainID, int64(testClientHeight.RevisionHeight), testClientHeightMinus1, now2, suite.valSet, suite.valSet, []tmtypes.PrivValidator{suite.privVal})
...
func (suite KeeperTestSuite) TestConsensusStateHelpers() {
	...
	chainATendermint := suite.chainA.TestChainClient.(*ibctesting.TestChainTendermint)
	header := chainATendermint.CreateTMClientHeader(testClientID, int64(testClientHeightPlus5.RevisionHeight), testClientHeight, suite.header.Header.Time.Add(time.Minute),
