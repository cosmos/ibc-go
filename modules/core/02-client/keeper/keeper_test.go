...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.header = suite.chainA.CreateTMClientHeader(testChainID, int64(testClientHeight.RevisionHeight), testClientHeightMinus1, now2, suite.valSet, suite.valSet, suite.valSet, []tmtypes.PrivValidator{suite.privVal})
...
func (suite KeeperTestSuite) TestConsensusStateHelpers() {
	...
	header := suite.chainA.CreateTMClientHeader(testClientID, int64(testClientHeightPlus5.RevisionHeight), testClientHeight, suite.header.Header.Time.Add(time.Minute),
		suite.valSet, suite.valSet, suite.valSet, []tmtypes.PrivValidator{suite.privVal})
