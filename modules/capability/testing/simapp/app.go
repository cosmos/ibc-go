...
func NewSimApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, consensusparamtypes.StoreKey,
	)
	...
	paramskeeper.NewKeeper(appCodec, legacyAmino, keys[paramstypes.StoreKey], tkeys[paramstypes.TStoreKey])
