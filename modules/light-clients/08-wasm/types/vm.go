...
func instantiateContract(ctx sdk.Context, clientStore storetypes.KVStore, checksum wasmvm.Checksum, msg []byte) (*wasmvmtypes.Response, error) {
...
func callContract(ctx sdk.Context, clientStore storetypes.KVStore, checksum wasmvm.Checksum, msg []byte) (*wasmvmtypes.Response, error) {
	sdkGasMeter := ctx.GasMeter()
	multipliedGasMeter := NewMultipliedGasMeter(sdkGasMeter, VMGasRegister)
	gasLimit := VMGasRegister.runtimeGasForContract(ctx)
...
func migrateContract(ctx sdk.Context, clientID string, clientStore storetypes.KVStore, checksum wasmvm.Checksum, msg []byte) (*wasmvmtypes.Response, error) {
	sdkGasMeter := ctx.GasMeter()
	multipliedGasMeter := NewMultipliedGasMeter(sdkGasMeter, VMGasRegister)
	gasLimit := VMGasRegister.runtimeGasForContract(ctx)
...
func queryContract(ctx sdk.Context, clientStore storetypes.KVStore, checksum wasmvm.Checksum, msg []byte) ([]byte, error) {
	sdkGasMeter := ctx.GasMeter()
	multipliedGasMeter := NewMultipliedGasMeter(sdkGasMeter, VMGasRegister)
	gasLimit := VMGasRegister.runtimeGasForContract(ctx)
