...
type GenesisContract struct {
	...
	CodeIdKey []byte `protobuf:"bytes,1,opt,name=code_id_key,json=codeIdKey,proto3" json:"code_id_key,omitempty"`
	// metadata value
...
var fileDescriptor_05e250654f164e20 = []byte{
	...
	,
}
...
func (m *GenesisContract) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CodeIdKey) > 0 {
		i -= len(m.CodeIdKey)
		copy(dAtA[i:], m.CodeIdKey)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.CodeIdKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GenesisContract) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CodeIdKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CodeIdKey = append(m.CodeIdKey[:0], dAtA[iNdEx:postIndex]...)
			if m.CodeIdKey == nil {
				m.CodeIdKey = []byte{}
			}
			iNdEx = postIndex
