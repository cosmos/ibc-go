...
## [v0.4.0+ibc-go-v7.4-wasmvm-v1.5](https://github.com/cosmos/ibc-go/releases/tag/modules%2Flight-clients%2F08-wasm%2Fv0.4.0%2Bibc-go-v7.4-wasmvm-v1.5) - 2024-12-20

### Dependencies

* [\#7744](https://github.com/cosmos/ibc-go/pull/7744) Bump wasmvm to 1.5.6 * (NOTE: This is a state machine breaking dependency update. See release notes for more details)
