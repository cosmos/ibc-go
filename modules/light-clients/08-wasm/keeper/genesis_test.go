...
func (suite *KeeperTestSuite) TestInitGenesis() {
	...
	testCases := []struct {
	...
	}{
		{
			"success",
			func() {
				codeHash := "c64f75091a6195b036f472cd8c9f19a56780b9eac3c3de7ced0ec2e29e985b64" //nolint:gosec // not a hard coded credential
...
func (suite *KeeperTestSuite) TestExportGenesis() {
	...
	expCodeHash := "c64f75091a6195b036f472cd8c9f19a56780b9eac3c3de7ced0ec2e29e985b64" //nolint:gosec // not a hard coded credential
