...
type ConsensusState struct {
	...
	NextValidatorsHash github_com_cometbft_cometbft_v2_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/cometbft/cometbft/v2/libs/bytes.HexBytes" json:"next_validators_hash,omitempty"`
}
...
type Header struct {
	*v2.SignedHeader  `protobuf:"bytes,1,opt,name=signed_header,json=signedHeader,proto3,embedded=signed_header" json:"signed_header,omitempty"`
	ValidatorSet      *v2.ValidatorSet `protobuf:"bytes,2,opt,name=validator_set,json=validatorSet,proto3" json:"validator_set,omitempty"`
	TrustedHeight     types.Height     `protobuf:"bytes,3,opt,name=trusted_height,json=trustedHeight,proto3" json:"trusted_height"`
	TrustedValidators *v2.ValidatorSet `protobuf:"bytes,4,opt,name=trusted_validators,json=trustedValidators,proto3" json:"trusted_validators,omitempty"`
}
...
func (m *Header) GetValidatorSet() *v2.ValidatorSet {
	if m != nil {
...
func (m *Header) GetTrustedValidators() *v2.ValidatorSet {
	if m != nil {
...
var fileDescriptor_c6d6cf2b288949be = []byte{
	...
	,
}
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SignedHeader == nil {
				m.SignedHeader = &v2.SignedHeader{}
			}
		...
		case 2:
			...
			if m.ValidatorSet == nil {
				m.ValidatorSet = &v2.ValidatorSet{}
			}
		...
		case 4:
			...
			if m.TrustedValidators == nil {
				m.TrustedValidators = &v2.ValidatorSet{}
			}
