...
func (suite *TendermintTestSuite) TestMisbehaviourValidateBasic() {
	...
	testCases := []struct {
		name                 string
		misbehaviour         *tendermint.Misbehaviour
		malleateMisbehaviour func(misbehaviour *tendermint.Misbehaviour) error
		expPass              bool
	}{
		{
		...
		},
		{
			...
			tendermint.NewMisbehaviour(clientID, nil, suite.header),
			func(m *tendermint.Misbehaviour) error { return nil },
			false,
		},
		{
			"misbehaviour Header2 is nil",
			tendermint.NewMisbehaviour(clientID, suite.header, nil),
			func(m *tendermint.Misbehaviour) error { return nil },
			false,
		},
		{
		...
		},
		{
			...
			func(misbehaviour *tendermint.Misbehaviour) error {
