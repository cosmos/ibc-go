...
<<<<<<< HEAD:modules/light-clients/07-tendermint/types/proposal_handle_test.go
...
>>>>>>> c86d27f (chore: increment go mod to v6 (#2318)):modules/light-clients/07-tendermint/proposal_handle_test.go
)
