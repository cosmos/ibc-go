...
func (suite *TendermintTestSuite) TestMisbehaviourValidateBasic() {
	...
	testCases := []struct {
		name                 string
		misbehaviour         *types.DuplicateHeaderHeader
		malleateMisbehaviour func(misbehaviour *types.DuplicateHeaderHeader) error
		expPass              bool
	}{
		{
			...
			func(misbehaviour *types.DuplicateHeaderHeader) error { return nil },
			true,
		},
		{
		...
		},
		{
			...
			types.NewDuplicateHeaderHeader(clientID, nil, suite.header),
			func(m *types.DuplicateHeaderHeader) error { return nil },
			false,
		},
		{
			"misbehaviour Header2 is nil",
			types.NewDuplicateHeaderHeader(clientID, suite.header, nil),
			func(m *types.DuplicateHeaderHeader) error { return nil },
			false,
		},
		{
		...
		},
		{
			...
			func(misbehaviour *types.DuplicateHeaderHeader) error {
