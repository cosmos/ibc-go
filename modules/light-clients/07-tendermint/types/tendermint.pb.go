...
<<<<<<< HEAD:modules/light-clients/07-tendermint/types/tendermint.pb.go
...
>>>>>>> c86d27f (chore: increment go mod to v6 (#2318)):modules/light-clients/07-tendermint/tendermint.pb.go
}
