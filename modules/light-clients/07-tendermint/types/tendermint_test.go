...
func (suite *TendermintTestSuite) SetupTest() {
	...
	suite.header = chainATendermint.CreateTMClientHeader(chainID, int64(height.RevisionHeight), heightMinus1, suite.now, suite.valSet, suite.valSet, []tmtypes.PrivValidator{suite.privVal})
