...
func (cs ClientState) CheckMisbehaviourAndUpdateState(
	...
	soloMisbehaviour, ok := misbehaviour.(*DuplicateSignatureHeader)
	if !ok {
		return nil, sdkerrors.Wrapf(
			clienttypes.ErrInvalidClientType,
			"misbehaviour type %T, expected %T", misbehaviour, &DuplicateSignatureHeader{},
		)
	}
...
func verifySignatureAndData(cdc codec.BinaryCodec, clientState ClientState, misbehaviour *DuplicateSignatureHeader, sigAndData *SignatureAndData) error {
