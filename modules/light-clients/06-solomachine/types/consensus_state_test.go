...
import (
<<<<<<< HEAD:modules/light-clients/06-solomachine/types/consensus_state_test.go
...
>>>>>>> c86d27f (chore: increment go mod to v6 (#2318)):modules/light-clients/06-solomachine/consensus_state_test.go
)
