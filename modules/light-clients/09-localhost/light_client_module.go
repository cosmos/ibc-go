...
func (lcm LightClientModule) TimestampAtHeight(ctx context.Context, _ string, _ exported.Height) (uint64, error) {
	ti := lcm.HeaderService.HeaderInfo(ctx).Time.UnixNano()
	return uint64(ti), nil
}
