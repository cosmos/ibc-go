...
* (core/03-connection) [\#6896](https://github.com/cosmos/ibc-go/pull/6896) The `portID` and `channelID` arguments in 03-connection's `Verify*` functions has been move to be after the context for consistency.
