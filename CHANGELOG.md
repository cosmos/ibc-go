 ...
 * (core/02-client) [\6934](https://github.com/cosmos/ibc-go/pull/6934) The `GetRouter` method has been removed from the keeper. `AddRoute` as a wrapper that replaces `GetRouter().AddRoute()`
