...
* (apps/27-interchain-accounts)[\#2302](https://github.com/cosmos/ibc-go/pull/2302) Use correct application version in favour of `channel.Version` in interchain accounts channel reopening handshake flow.
