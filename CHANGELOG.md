...
* (apps/transfer) [\#2651](https://github.com/cosmos/ibc-go/pull/2651) Introduce `mustProtoMarshalJSON` for ics20 packet data marshaling which will skip emission (marshaling) of the memo field if unpopulated (empty). 
