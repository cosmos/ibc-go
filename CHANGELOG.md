...
* (core) [\#9094](https://github.com/cosmos/ibc-go/pull/9094) Export the IBC v2 packet state stored under aliased v1 channel identifiers, and restore the v2 counterparty and alias of OPEN UNORDERED channels in `InitGenesis`, so that aliased v2 packet flows survive a genesis export and import.
