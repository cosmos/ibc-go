...
* (apps/27-interchain-accounts) [\#2035](https://github.com/cosmos/ibc-go/pull/2035) Interchain host and client Keepers now expects a keeper which fulfills the expected `ScopedKeeper` interface for the capability keeper.
