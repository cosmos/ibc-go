...
* (modules/core/02-client) [\#1195](https://github.com/cosmos/ibc-go/pull/1189) Removing `CheckHeaderAndUpdateState` from `ClientState` interface & associated light client implementations. 
