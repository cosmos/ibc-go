...
* (07-tendermint) [\#1674](https://github.com/cosmos/ibc-go/pull/1674) Submitted client state is zeroed out before checking the proof in order to prevent the proposal from containing information governance is not actually voting on.
