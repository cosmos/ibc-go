...
// Use specific version of CometBFT that's compatible with the SDK
replace github.com/cometbft/cometbft => github.com/cometbft/cometbft v1.0.1

// Use CometBFT API package for proto types
replace github.com/cometbft/cometbft/proto/tendermint/types => github.com/cometbft/cometbft/api/cometbft/types v1.0.1
