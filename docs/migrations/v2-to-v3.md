...
```go
github.com/cosmos/ibc-go/v3 -> github.com/cosmos/ibc-go/v3
```
...
Please review the [mock](../../testing/mock/ibc_module.go) and [transfer](../../modules/apps/transfer/ibc_module.go) modules as examples.    
