...
Please read the Fee Middleware [integration documentation](../middleware/ics29-fee/integration.md) for an in depth guide on how to congfigure the module correctly in order to incentivize IBC packets. 
