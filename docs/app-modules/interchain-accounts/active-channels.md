...
In the case of a channel closing a controller chain needs to be able to regain access to the interchain account registered on this channel. `Active Channels` enable this funtionality. Future versions of the ICS-27 protocol and Interchain Accounts module will likely use a new 
