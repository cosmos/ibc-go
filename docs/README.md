...
This command will run `lychee` (if you don't have it, see the [install docs](https://lychee.cli.rs/guides/getting-started/)) and check all links in `./docs/docs` (i.e. it will not check versioned docs).
