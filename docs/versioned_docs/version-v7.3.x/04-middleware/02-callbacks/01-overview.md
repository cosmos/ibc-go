...
After much discussion, the design was expanded to [an ADR](https://github.com/cosmos/ibc-go/blob/v7.3.0/docs/architecture/adr-008-app-caller-cbs/adr-008-app-caller-cbs.md), and the Callbacks Middleware is an implementation of that ADR.
