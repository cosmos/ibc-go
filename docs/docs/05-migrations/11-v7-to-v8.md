...
- All e2e tests of the repository can be [run with custom Docker chain images](https://github.com/cosmos/ibc-go/blob/fec07ec55ca3e35f49a62bc6b1243c27cdf7799d/e2e/README.md#running-tests-with-custom-images).
- An [importable workflow](https://github.com/cosmos/ibc-go/blob/fec07ec55ca3e35f49a62bc6b1243c27cdf7799d/e2e/README.md#importable-workflow) that can be used from any other repository to test chain upgrades.
