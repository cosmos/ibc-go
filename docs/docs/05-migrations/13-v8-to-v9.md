...
- With support for multidenom transfer packets, the `NewMsgTransfer` contrustor function to create a new `MsgTransfer` instance accepts now multiple coins instead of just one:
