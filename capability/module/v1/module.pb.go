...
func (*Module) Descriptor() ([]byte, []int) {
	return fileDescriptor_c4431b5613c207cc, []int{0}
}
...
func (m *Module) GetSealKeeper() bool {
	if m != nil {
		return m.SealKeeper
	}
	return false
...
func init() {
	proto.RegisterType((*Module)(nil), "capability.module.v1.Module")
}

func init() { proto.RegisterFile("capability/module/v1/module.proto", fileDescriptor_c4431b5613c207cc) }

var fileDescriptor_c4431b5613c207cc = []byte{
	// 185 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x4c, 0x4e, 0x2c, 0x48,
	0x4c, 0xca, 0xcc, 0xc9, 0x2c, 0xa9, 0xd4, 0xcf, 0xcd, 0x4f, 0x29, 0xcd, 0x49, 0xd5, 0x2f, 0x33,
	...
	0x89, 0x39, 0x05, 0x19, 0x89, 0xa8, 0xfa, 0x94, 0xc2, 0xb8, 0xd8, 0x7c, 0xc1, 0x7c, 0x21, 0x79,
	0x2e, 0xee, 0xe2, 0xd4, 0xc4, 0x9c, 0xf8, 0xec, 0xd4, 0xd4, 0x82, 0xd4, 0x22, 0x09, 0x46, 0x05,
	0x46, 0x0d, 0x8e, 0x20, 0x2e, 0x90, 0x90, 0x37, 0x58, 0xc4, 0x4a, 0x7b, 0xd7, 0x81, 0x69, 0xb7,
	0x18, 0x55, 0xb9, 0x94, 0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0xa1,
	0xe6, 0x67, 0x26, 0x25, 0xeb, 0xa6, 0xe7, 0xeb, 0x23, 0xdc, 0xe0, 0x24, 0x71, 0xe2, 0x91, 0x1c,
	...
	0xff, 0x3b, 0x7d, 0xd2, 0x59, 0xd5, 0x00, 0x00, 0x00,
}
...
func (m *Module) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SealKeeper", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
